...
class IEEE802_11:
    ...
    def print_meta(self):
        print("Version: {}".format(self.frame['Version']))
        print("Type: {}".format(self.frame['Type']))
        print("SubType: {}".format(self.frame['SubType']))
        print("toDS: {}".format(self.frame['toDS']))
        print("fromDS: {}".format(self.frame['fromDS']))
        print("moreFragments: {}".format(self.frame['moreFragments']))
        print("retry: {}".format(self.frame['retry']))
        print("pwrmgt: {}".format(self.frame['pwrmgt']))
        print("moreData: {}".format(self.frame['moreData']))
        print("protected: {}".format(self.frame['protected']))
        print("order: {}".format(self.frame['order']))
        print("fragmentnum: {}".format(self.frame['fragmentnum']))
        print("sequenznum: {}".format(self.frame['sequenznum']))
        if self.frame['DA']:
