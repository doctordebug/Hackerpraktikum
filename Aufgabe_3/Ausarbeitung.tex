...
\end{lstlisting}
\end{center}
Es werden einige Parameter geladen. Die Variablen welche mit dem Präfix victim\_dns\_ beginnen, legen den zu vergiftenden Nameserver fest. In victim\_host\_base steht die URL, welche später vom Victim-DNS in den Cache übernommen werden soll. Zuletzt kommt attacker\_dns\_ip welche die IP des vom Attacker kontrollierten DNS-Servers (Attacker-DNS) beinhaltet.
